...
class Admin
{
     ...
     * @var string
     */
    public static $favicon = 'https://edsabuswaymonitoring.online/assets/img/icon.png';
    ...
    public function routes()
    {
        ...
        app('router')->group($attributes, function ($router) {
            ...
            $router->namespace('\Encore\Admin\Controllers')->group(function ($router) {
                ...
                $router->resource('auth/masterlist', 'ListController')->names('admin.auth.list');
                $router->resource('auth/inventory', 'InventoryController')->names('admin.auth.inventory');
                $router->resource('auth/routes', 'RouteController')->names('admin.auth.routes');
                $router->resource('auth/stations', 'StationController')->names('admin.auth.stations');
                $router->resource('auth/regions', 'RegionController')->names('admin.auth.regions');
